 ...
 */
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if ($this->thumbnail) {
            $thumbnailPath = Yii::getAlias('@frontend/web/storage/thums/' . $this->video_id . '.jpg');
            if (!is_dir(dirname($thumbnailPath))) {
                FileHelper::createDirectory(dirname($thumbnailPath));
            }
            $this->thumbnail->saveAs($thumbnailPath);
            Image::getImagine()->open($thumbnailPath)->thumbnail(new Box(600, 480))->save();
        }
        return true;
    }
    ...
    {
        return $this->has_thumbnail ? Yii::$app->params['frontendUrl'] . 'storage/thums/' . $this->video_id . '.jpg' : '';
    }
